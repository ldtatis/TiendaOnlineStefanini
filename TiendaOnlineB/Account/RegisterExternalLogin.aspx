<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="TiendaOnlineB.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="TiendaOnlineB" %>
